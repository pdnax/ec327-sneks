...
public class GameEngineOne {
    public static final int GameWidth = 35; //Width of the game window
    public static final int GameHeight = 50;//Height of the game window
    public static int updateDelay = 150;
    ...
    public GameEngineOne(){ // Creates the engine of the game
    }
    ...
    private void AddSnake(){ // Makes a snake with 5 elements
        snake.clear();
        snake.add(new Coordinate(17,15)); //Location of the head of snake
        snake.add(new Coordinate(16,15));
    ...
    private void AddWalls(){
        ...
        for(int x = 1; x < GameWidth; x++)
        {
            ...
            walls.add(new Coordinate(x,GameHeight - 15)); // Creates a new wall object
        }
        //Left and Right Walls
        for(int y = 1; y < ( GameHeight-15 ) ; y++)
        {
    ...
    private void randomWall(){ //Add random walls to the game after the parameter is met
        ...
        while(!added) { // Prevents an wall from spawning inside the snake or another wall
            ...
            int y = 1 + random.nextInt(GameHeight - 17); // Away from the outer walls
